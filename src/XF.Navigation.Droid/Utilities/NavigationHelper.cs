...
namespace XF.Navigation.Droid.Utilities
{
    ...
    {
        private static DisplayMetrics DisplayMetrics => Navigator.Context.Resources.DisplayMetrics;
        ...
        {
            return ContextCompat.GetDrawable(Navigator.Context, resId).GetConstantState().NewDrawable().Mutate();
        }

        internal static TDrawable GetDrawableCopyFromResource<TDrawable>(int resId) where TDrawable : Drawable
        {
            return ContextCompat.GetDrawable(Navigator.Context, resId).GetConstantState().NewDrawable().Mutate() as TDrawable;
        }
